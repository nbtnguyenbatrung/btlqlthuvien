...
{
    public partial class Frm_listsach : Form
    {
        #region Fields
        ...
        {
            this.dgvsach.Rows[e.RowIndex].Cells["STT"].Value = (e.RowIndex + 1).ToString();
        }

        private void Frm_listsach_Load(object sender, EventArgs e)
        {
